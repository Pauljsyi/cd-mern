  ...
  const handleValidation = (e) => {
    ...
    if (fieldName === "firstName") {
      if (value.length < 1) {
        ...
        setErrors({
          ...errors,
          [fieldName]: "First Name must be 2 characters or longer!",
        });
        isValidSubmission = false;
      } else {
    ...
    if (fieldName === "lastName") {
      if (value.length < 1) {
        ...
        setErrors({
          ...errors,
          [fieldName]: "Last Name must be 2 characters or longer!",
        });
        isValidSubmission = false;
      } else {
        setErrors({ ...errors, [fieldName]: "" });
    ...
    if (fieldName === "email") {
      if (value.length < 1) {
        ...
        setErrors({
          ...errors,
          [fieldName]: "Email must be 5 characters or longer!",
        });
        isValidSubmission = false;
      } else {
        setErrors({ ...errors, [fieldName]: "" });
    ...
    if (fieldName === "password") {
      if (value.length < 1) {
        ...
        setErrors({
          ...errors,
          [fieldName]: "Password must be 8 characters or longer!",
        });
        isValidSubmission = false;
      } else {
        setErrors({ ...errors, [fieldName]: "" });
    ...
    if (fieldName == "confirmPassword") {
      if (value.length < 1) {
        ...
        setErrors({
          ...errors,
          [fieldName]: "Passwords must be 8 characters or longer!",
        });
        isValidSubmission = false;
